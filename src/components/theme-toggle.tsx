...
export function ThemeToggle() {
    ...
    return (
        <div className="relative" ref={ref}>
            ...
            <div
                className={`absolute right-0 top-full mt-2 w-36 rounded-lg border bg-card shadow-lg py-1 z-50 transition-all duration-200 ease-out origin-top-right ${open
