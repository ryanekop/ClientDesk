...
export default function FinancePage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <PageHeader
                actions={(
                    <>
                        ...
                        <TableColumnManager
                            title={ti("columnManagerTitle")}
                            description={ti("columnManagerDescription")}
                            columns={columns}
            ...
            >
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">{ti("title")}</h2>
                    <p className="text-muted-foreground">{ti("subtitle")}</p>
                </div>
            </PageHeader>
